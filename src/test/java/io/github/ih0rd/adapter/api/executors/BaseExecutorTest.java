...
class BaseExecutorTest {
    ...
    void shouldCacheSource() {
        ...
        executor.sourceCache.put(String.class, src1);
        executor.sourceCache.computeIfAbsent(String.class, k -> src2);
        assertThat(executor.sourceCache.get(String.class)).isEqualTo(src1);
    }
