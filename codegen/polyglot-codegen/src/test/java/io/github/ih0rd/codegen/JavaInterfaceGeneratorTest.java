...
class JavaInterfaceGeneratorTest {
    ...
    void generate_ShouldRenderImportsForCollections() {
        // List<String>
        ContractMethod m1 = new ContractMethod("listMethod", List.of(), new PolyList(PolyPrimitive.STRING));
        // Map<String, Integer>
        ContractMethod m2 = new ContractMethod("mapMethod", List.of(), new PolyMap(PolyPrimitive.STRING, PolyPrimitive.INT));
