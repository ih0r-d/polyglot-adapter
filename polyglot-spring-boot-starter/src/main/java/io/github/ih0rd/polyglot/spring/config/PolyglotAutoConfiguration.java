...
import io.github.ih0rd.polyglot.spring.internal.PolyglotStartupValidator;
...
public class PolyglotAutoConfiguration {
    ...
    PolyglotStartupValidator polyglotStartupValidator(
            PolyglotProperties properties,
            @Autowired(required = false) PyExecutor pyExecutor,
            @Autowired(required = false) JsExecutor jsExecutor) {

        return new PolyglotStartupValidator(
                properties,
                pyExecutor,
                jsExecutor
        );
